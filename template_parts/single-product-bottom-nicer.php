  ...
  <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
          <img style="" src="https://noriks.com/hu/wp-content/uploads/2026/01/starter-1_GR.png">
      </div>
    </div>
...
<section style="background: white;" class="why-section">
   <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
           <img style="" src="https://noriks.com/hu/wp-content/uploads/2026/01/starter-2_gr.png">
      </div>
    </div>
...
<section class="why-section">
   <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
          <img style="" src="https://noriks.com/hu/wp-content/uploads/2026/01/starter-3_gr.png">
      </div>
    </div>
...
<?php
if (  has_term( array( 'tricka', 'orto-majice', 'mplouzoakia', 't-shirts', 'blouzakia' ), 'product_cat', get_the_id() )  ||  has_term( array('sady', 'set', 'seta', 'bundles'), 'product_cat', get_the_id() )) :
?>
    ...
    <div class="why-col">
      <div class="video-wrapper">
        <video
          ...
          class="why-video">
          <source src="https://noriks.com/hu/wp-content/uploads/2025/09/noriks_gif_gr_2-1.mp4" type="video/mp4">
...
<?php if ( has_term( array( 'boxerky', 'orto-bokserice', 'mpoxerakia', 'boxers', 'boxerakia' ), 'product_cat', get_the_ID() )  && !has_term( 'black-friday', 'product_cat', get_the_ID() ) ): ?>
...
<section  style="background: white;" class="why-section">
  <div class="container why-container">
    ...
    <!-- Left Video -->
    <div class="why-col">
       <img src="https://noriks.com/hu/wp-content/uploads/2026/01/prednosti-in-lastnosti2_gr.png">
    </div>
...
<?php
  ...
  function get_wc_product_pool(
      ...
      $is_bokserice = false;
      if ( $product_id ) {
          $is_bokserice = has_term( array( 'bokserice','orto-bokserice', 'bokserice-sastavi-paket', 'boxerky', 'mpoxerakia', 'boxers', 'boxerakia' ), 'product_cat', $product_id );
      }
