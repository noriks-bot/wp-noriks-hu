...
@media (max-width: 640px) {
  ...
  <div class="collections__grid">
    <!-- Card 1 -->
    <a class="collection-card" href="/hu/shop/?filter_product_cat=t-shirts">
...
Egész napos kényelem. Nem húzódik fel.
    ...
    <!-- Card 2 -->
    <a class="collection-card" href="/hu/shop/?filter_product_cat=boxers">
      <div class="collection-card__media">
        <img
   ...
   Puha. Légáteresztő. Megbízható.
    ...
    <!-- Card 3 -->
    <a class="collection-card" href="/hu/product-category/bundles/">
      <div class="collection-card__media">
        <img
...
A legjobb ár-érték arány csomagban.
    ...
    <!-- Card 4 - Starter Pack -->
    <a class="collection-card" href="/hu/shop/?filter_product_cat=starter-pack">
      <div class="collection-card__media">
        <img
